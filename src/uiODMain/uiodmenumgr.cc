...
void uiODMenuMgr::fillExportMenu()
{
    ...
    auto* exppdf = new uiMenu( &appl_, uiStrings::sProbDensFunc(false,mPlural));
    auto* expmute = new uiMenu( &appl_, uiStrings::sMuteFunc(mPlural) );
    auto* expseis = new uiMenu( &appl_, uiStrings::sSeismicData() );
    auto* expwvlt = new uiMenu( &appl_, uiStrings::sWavelet(mPlural) );
...
void uiODMenuMgr::fillUtilMenu()
{
	...
	if ( !aitfixed || ait == ODInst::AutoInstType::UseManager ||
			  ait == ODInst::AutoInstType::FullAuto )
